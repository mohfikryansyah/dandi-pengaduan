...
import { statusColorMap } from './show-pengaduan';

// Hook untuk mendapatkan columns berdasarkan role user
export const useColumns = (): ColumnDef<Pengaduan>[] => {
    ...
    return useMemo(() => {
        ...
        // Kolom Nama - hanya ditampilkan untuk role selain 'masyarakat'
        if (!isMasyarakat) {
            columns.push({
                    ...
                    return (
                        <>
                            <div className="flex items-center">
                                ...
                                {row.original.latest_status.status !== 'Selesai' && (
                                    <>
                                        {hasRole(auth.user, ['kades']) && (
                                            <div className="flex">
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction
                                                                ...
                                                                onClick={() => handleApprove(row.original, 'Selesai')}
                                                            >
                                                                Ya, saya yakin!
                                                            </AlertDialogAction>
                                                        </AlertDialogFooter>
                                                    ...
                                                    <AlertDialogContent>
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction
                                                                ...
                                                                onClick={() => handleReject(row.original, 'Ditolak Kades')}
                                                            >
                                                                Ya, saya yakin!
                                                            </AlertDialogAction>
                                                        </AlertDialogFooter>
